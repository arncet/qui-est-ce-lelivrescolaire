const allNews = [
  ...
  { id: 97, name: 'Yohann Rabatel', job: `Motion designer<br/>🎥 🍻 📚`, picture: 'images/pictures/new/Yohann_Rabatel_new.jpg' }, 
  { id: 98, name: 'Eléna Sonntag', job: `Product designer<br/>✨ 🎨 💃 🐱 🧁 ✈️`, picture: 'images/pictures/new/Eléna_ Sonntag_new.JPG' }, 
  { id: 99, name: 'Jonathan Biteau', job: `Développeur Squad Communauté<br/>🍻 🌯 🍻`, picture: 'images/pictures/new/Jonathan_Biteau_new.jpg' }, 
  { id: 100, name: 'Matthieu Brunerie', job: `Responsable QA<br/>🐛 🤿 🕵️‍♂️`, picture: 'images/pictures/new/Matthieu_Brunerie_new.jpg' }, 
  { id: 101, name: 'Evan Wichlarz', job: `Développeur Squad Accompagnement<br/>₿ 📈 🕵️‍🍻`, picture: 'images/pictures/new/Evan_Wichlarz_new.png' }
