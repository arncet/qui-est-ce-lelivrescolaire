export default [
  ...
  { id: 12, name: 'Fabien Pinel', job: 'Développeur web front-end<br/>💻 🚐 🚴🏻‍♂️', picture: 'images/pictures/new/fabien-dev.png' },
  ...
  { id: 16, name: 'Joëlle Dutreilly', job: 'Graphiste SVT<br/>👩🏻‍🎨 🌿 🧘🏼‍♀️', picture: 'images/pictures/new/joelle-pao-svt.jpg' },
  ...
  //{ id: 24, name: 'Maël Joyeux', job: 'Directrice d'ouvrage Anglais<br/>🤶 🇬🇧', picture: 'images/pictures/new/mael.png' },
  ...
  { id: 29, name: 'Raphael Taïeb', job: 'Président directeur<br/>🤴🏻 🚴🏻‍♂️ 🏆', picture: 'images/pictures/new/raph.jpg' },
  ...
  { id: 48, name: 'Maximilien Derrier', job: 'DevOps<br/>🧙🏻‍♂️ 🧝🏻‍♂️ 🧔🏻 💻 🦸🏻‍♂️ 🤓 🖨 👨🏻‍🚒 🧞‍♂️ 👹 👨🏻‍🚀 🛰 🚀 📡', picture: 'images/pictures/new/max-dev.jpeg' },
  ...
  { id: 53, name: 'Vincent Bourgeois', job: 'Développeur web back-end<br/>💻 💪🏻 🏋🏻‍♂️', picture: 'images/pictures/new/vincent-dev.jpg' },
  { id: 54, name: 'Cédric Soubrié', job: 'Développeur mobile iOS<br/>📱 🎾 🤓', picture: 'images/pictures/new/cedric-dev.jpg' },
  { id: 55, name: 'Frédéric Adda', job: 'Développeur mobile iOS<br/>📱 🤼‍♂️ 🥋', picture: 'images/pictures/new/fred.png' },
